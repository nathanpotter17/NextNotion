...
export const Item = ({id, label, onClick, icon: Icon, documentIcon, active, isSearch, level = 0, onExpand, expanded,}: ItemProps) => {
    ...
    <div onClick={onClick} role="button" style={{ paddingLeft: level ? `${(level * 12) + 12}px` : '12px'}} className={cn("group min-h-[27px] text-sm py-1 pr-3 w-full hover:bg-primary/5 flex items-center text-muted-foreground font-medium", active && 'bg-primary/5 text-primary')}>
      ...
      {!!id && (
        <div className="ml-auto flex items-center gap-x-2">
          ...
          <div role="button" onClick={onCreate} className="opacity-0 group-hover:opacity-100 h-full ml-auto rounded-sm hover:bg-neutral-300 mr-1 dark:hover:bg-neutral-600">
